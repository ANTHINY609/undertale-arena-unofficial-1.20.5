...
data modify block 255 0 255 Items[0].components set from entity @s Inventory[{Slot:101b}].components
...
data modify block 255 0 255 Items[0].components set from entity @s Inventory[{Slot:102b}].components
execute store result block 255 0 255 Items[0].components."minecraft:dyed_color" int 1 run scoreboard players get -color store
