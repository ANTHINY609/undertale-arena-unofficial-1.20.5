...
clear @s carrot_on_a_stick[minecraft:custom_data={soul:1b,canned:0b,nonboss:0b}] 1
...
loot give @s mine 255 0 255 minecraft:diamond_pickaxe[minecraft:custom_data={isShulkerMarker:1b}]