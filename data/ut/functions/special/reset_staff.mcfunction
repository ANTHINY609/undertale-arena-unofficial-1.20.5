...
summon chicken 269.5 148 1295.5 {Silent:1b,Invulnerable:1b,ForcedAge:1,Age:-24000,PersistenceRequired:1b,Tags:["pokemon","staff","farfetchd","active","ray_target"], HandItems:[{},{id:"minecraft:bamboo",Count:1b,components:{"minecraft:item_name":'"Green Onion"'}}],CustomName:'"little duck"'}

#tv
summon painting 273.0 142 1292.0 {Invulnerable:1b,Tags:["staff","tv"],CustomName:'"tv_main"',Motive: "minecraft:fighters",Facing:0b}

summon armor_stand 275.0 142.7 1292.0 {Small:1b,Marker:1b,Invisible:1b,Tags:["staff","tv"],CustomName:'"tv_sans"',ArmorItems:[{},{},{},{id:"player_head",Count:1b,components:{"minecraft:profile":{properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOTVhZWY4ZDczYzZiM2I5N2Q3YjU3MTZmY2EyMTVmNWViYTY3OTkyMTJkMTFlYjYzZTE1ODg5NDBkMWUyMWI3MyJ9fX0="}]},"minecraft:item_name":'"sans"'}}],Rotation:[30.0f,0.0f]}

summon armor_stand 273.1 142.5 1292.0 {Small:1b,Marker:1b,Invisible:1b,Tags:["staff","tv"],CustomName:'"tv_papy"',ArmorItems:[{},{},{},{id:"player_head",Count:1b,components:{"minecraft:profile":{properties: [{name:"textures",value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmE4OTQyNzMwOTc3MzQzYjc5MzJkMjdlYzc4ZDViNTQ5MThjMjEzMTViN2E2YmYwOWE2NTU0ZjMyMzA4MGZiMCJ9fX0="}]},"minecraft:item_name":'"papy"'}}],Rotation:[-30.0f,0.0f]}

#alphys' pc
summon painting 252.0 143.5 1292.0 {Tags:["staff","screen"],Facing:3b,Invulnerable:1b,Motive:"donkey_kong",CustomName:'"PC Screen"'}

#temz
summon cat 252.5 143 1274.5 {NoAI:1b,NoGravity:1b,Invulnerable:1b,PersistenceRequired:1b,Silent:1b,Sitting:1b,CatType:8,Tags:["staff","tem"],Rotation:[-90.0f],CustomName:'"Tem"'}

summon cat 252.5 143 1272.5 {NoAI:1b,NoGravity:1b,Invulnerable:1b,PersistenceRequired:1b,Silent:1b,Sitting:1b,CatType:8,Tags:["staff","tem"],Rotation:[-90.0f],CustomName:'"Tem"'}

summon cat 252.5 143 1270.5 {NoAI:1b,NoGravity:1b,Invulnerable:1b,PersistenceRequired:1b,Silent:1b,Sitting:1b,CatType:8,Tags:["staff","tem"],Rotation:[-90.0f],CustomName:'"Tem"'}

summon cat 252.5 143 1268.5 {NoAI:1b,NoGravity:1b,Invulnerable:1b,PersistenceRequired:1b,Silent:1b,Sitting:1b,CatType:8,Tags:["staff","tem","bob"],Rotation:[-90.0f],CustomName:'"Bob"'}

summon painting 253.0 145.0 1273.0 {Invulnerable:1b,Tags:["staff","tem","paint"],CustomName:'"tem legend"',Facing:3b,Motive:"minecraft:fighters"}
