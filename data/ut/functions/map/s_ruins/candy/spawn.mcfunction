...
###Prepare Item
item replace entity 0-0-0-0-1 container.0 with glow_berries[minecraft:custom_data={monster_candy:1b,can_fist:1b},minecraft:attribute_modifiers={modifiers:[],show_in_tooltip:false},minecraft:item_name='{"text":"","color":"white","italic":false,"bold":true,"extra":[{"translate":"itm.candy"}]}',minecraft:lore=['""','{"text":"","color":"white","italic":false,"bold":false,"extra":[{"translate":"itm.candy1"}]}','{"text":"","color":"white","italic":false,"bold":false,"extra":[{"translate":"itm.candy2"}]}']] 1
