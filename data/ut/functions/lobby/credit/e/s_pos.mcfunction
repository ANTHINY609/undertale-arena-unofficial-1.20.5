...
summon firework_rocket ~ ~ ~ {LifeTime:20,FireworksItem:{id:firework_rocket,Count:1,components:{"minecraft:fireworks":{explosions:[{shape:"small_ball",trail:0,colors:[I;11743532,14602026],fade_colors:[I;15435844]}],flight_duration:1b}}}}