...
execute if score setSoul gamerule matches 1 run item replace entity @e[tag=experiment_soul,limit=1] armor.head with charcoal[minecraft:custom_model_data=1]
...
execute if score voidProtection gamerule matches 1 run item replace entity @e[tag=experiment_void,limit=1] armor.head with charcoal[minecraft:custom_model_data=1]
