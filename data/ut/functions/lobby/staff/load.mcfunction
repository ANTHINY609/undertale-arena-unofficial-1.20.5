...
##269.5 148 1295.5
execute at @e[tag=lobby_center] run summon chicken ~-3 ~-5 ~15 {ForcedAge:1,Silent:1b,Invulnerable:1b,Age:-24000,PersistenceRequired:1b,Tags:["pokemon","staff","farfetchd","active","ray_target"], HandItems:[{},{id:"minecraft:bamboo",Count:1b,components:{"minecraft:item_name"='"Green Onion"'}}],CustomName:'"little duck"'}
...
##275.0 142.7 1292.0
execute at @e[tag=lobby_center] run summon armor_stand ~2.5 ~-10.3 ~11.5 {Small:1b,Marker:1b,Invisible:1b,Tags:["staff","tv"],CustomName:'"tv_sans"',ArmorItems:[{},{},{},{id:"player_head",Count:1b,components:{"minecraft:profile": {properties: [{name:"textures",value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOTVhZWY4ZDczYzZiM2I5N2Q3YjU3MTZmY2EyMTVmNWViYTY3OTkyMTJkMTFlYjYzZTE1ODg5NDBkMWUyMWI3MyJ9fX0="}]},"minecraft:item_name":'"sans"'}}],Rotation:[30.0f,0.0f]}

##273.1 142.5 1292.0
execute at @e[tag=lobby_center] run summon armor_stand ~.6 ~-10.5 ~11.5 {Small:1b,Marker:1b,Invisible:1b,Tags:["staff","tv"],CustomName:'"tv_papy"',ArmorItems:[{},{},{},{id:"player_head",Count:1b,components:{"minecraft:profile": {properties: [{name:"textures",value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmE4OTQyNzMwOTc3MzQzYjc5MzJkMjdlYzc4ZDViNTQ5MThjMjEzMTViN2E2YmYwOWE2NTU0ZjMyMzA4MGZiMCJ9fX0="}]},"minecraft:item_name":'"papy"'}}],Rotation:[-30.0f,0.0f]}
