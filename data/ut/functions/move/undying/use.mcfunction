...
execute if data entity @s Inventory[{Slot:103b,tag:{CustomModelData:103}}] anchored eyes run particle item{item: "minecraft:iron_chestplate"} ^ ^ ^.1 0.225 0.225 0.225 0.1 75 normal @a[scores={Q=1..}]
