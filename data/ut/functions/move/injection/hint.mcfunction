...
execute positioned ^ ^ ^2.5 at @e[type=!player,tag=inject_target,limit=1,distance=..4] run particle dust{color:[0.0,1.0,0.0],scale:1.0} ~ ~1.8 ~ .3 .3 .3 0 3 force @s
execute positioned ^ ^ ^4.5 at @e[type=player,tag=inject_target,limit=1,distance=..6] run particle dust{color:[0.0,1.0,0.0],scale:1.0} ~ ~1 ~ .3 .7 .3 0 3 force @s

execute unless entity @e[tag=inject_target] at @s run particle dust{color:[0.0,1.0,0.0],scale:1.0} ~ ~1 ~ .3 .7 .3 0 3 force @s
