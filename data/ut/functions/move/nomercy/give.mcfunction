...
execute if entity @s[tag=!cev] unless data entity @s Inventory[{Slot:7b}] run loot replace entity @s container.7 1 mine 255 0 255 minecraft:diamond_pickaxe[minecraft:custom_data={isShulkerMarker:1b}]
execute unless data entity @s Inventory[{tag:{nomercy:1b}}] run loot give @s mine 255 0 255 minecraft:diamond_pickaxe[minecraft:custom_data={isShulkerMarker:1b}]