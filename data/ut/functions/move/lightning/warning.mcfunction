...
particle dust{color:[1.0,0.0,0.0],scale:1.5} ^ ^2 ^ 0 1 0 0 5 force @a[tag=lightning_target,scores={Q=..1}]
particle dust{color:[0.09,0.78,0.0],scale:1.5} ^ ^2 ^ 0 1 0 0 5 force @a[tag=!lightning_target,scores={Q=..1}]
