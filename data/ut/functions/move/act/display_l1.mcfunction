...
particle dust{color:[0.859,0.718,0.353],scale:0.5} ^ ^-.5 ^ 0.01 0.01 0.01 0.1 2 normal @a[scores={Q=1..}]
execute if score -raylim store matches ..25 run particle dust{color:[0.859,0.718,0.353],scale:0.75} ^ ^-.5 ^ 0.03 0.03 0.03 0.1 2 normal @a[scores={Q=2..}]
execute if score -raylim store matches ..20 run particle dust{color:[0.859,0.718,0.353],scale:1.0} ^ ^-.5 ^ 0.03 0.03 0.03 0.1 2 normal @a[scores={Q=2..}]
