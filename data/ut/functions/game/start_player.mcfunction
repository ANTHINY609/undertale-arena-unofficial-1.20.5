...
execute if data entity @s Inventory[{Slot:102b,components:{"minecraft:custom_data":{passive:"random"}}}] run scoreboard players set @s istobychr 1
#forceChoose
...
#Random
execute if data entity @s Inventory[{Slot:102b,components:{"minecraft:custom_data":{passive:"random"}}}] run function ut:choose/random
#Score
